 ...
 *
 * **Methods:**
 * 1. `\Illuminate\Database\Eloquent\Model|null create(\Core\Utils\DataTransfertObjects\DTOInterface $data)`:           Creates a new record
 * 2. `bool|\Illuminate\Database\Eloquent\Model|null update($id, \Core\Utils\DataTransfertObjects\DTOInterface $data)`: Update an existing record.
...
interface ReadWriteServiceContract extends QueryServiceContract
{
     ...
     */
    public function create(\Core\Utils\DataTransfertObjects\DTOInterface $data);
     ...
     */
    public function update($id, \Core\Utils\DataTransfertObjects\DTOInterface $data);
