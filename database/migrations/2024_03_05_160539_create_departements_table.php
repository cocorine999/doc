...
/**
 * Class ***`CreateDepartementsTable`***
 *
 * A migration class for creating the "departements" table with UUID primary key and timestamps.
 *
 * @package ***`\Database\Migrations\CreateDepartementsTable`***
 */
class CreateDepartementsTable extends Migration
{
    ...
    public function up(): void
    {
        ...
        try {
            ...
            Schema::create('departements', function (Blueprint $table) {
                // Define a UUID primary key for the 'departements' table
                $this->uuidPrimaryKey($table);
                
                // Define a unique string column for the departements name
                $table->string('name')->unique()->comment('The unique name of the departements');
            ...
            throw new \Core\Utils\Exceptions\DatabaseMigrationException(
                message: 'Failed to migrate "departements" table: ' . $exception->getMessage(),
                previous: $exception
            );
        }
    }
    ...
    public function down(): void
    {
        ...
        try {
            // Drop the "departements" table if it exists
            ...
            // Handle the exception (e.g., logging, notification, etc.)
            throw new \Core\Utils\Exceptions\DatabaseMigrationException(
                message: 'Failed to drop "departements" table: ' . $exception->getMessage(),
                previous: $exception
            );
        }
    }
