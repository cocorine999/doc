...
/**
 * Class ***`CreateUniteMesuresTable`***
 *
 * A migration class for creating the "unite_mesures" table with UUID primary key and timestamps.
 *
 * @package ***`\Database\Migrations\CreateUniteMesuresTable`***
 */
class CreateUniteMesuresTable extends Migration
{
    ...
    public function up(): void
    {
        ...
        try {
            ...
            throw new \Core\Utils\Exceptions\DatabaseMigrationException(
                message: 'Failed to migrate "unite_mesures" table: ' . $exception->getMessage(),
                previous: $exception
            );
        }
    }
    ...
    public function down(): void
    {
        ...
        try {
            ...
            // Handle the exception (e.g., logging, notification, etc.)
            throw new \Core\Utils\Exceptions\DatabaseMigrationException(
                message: 'Failed to drop "unite_mesures" table: ' . $exception->getMessage(),
                previous: $exception
            );
        }
    }
