...
namespace Core\Utils\DataTransfertObjects;
 ...
 *
 * @package \Core\Utils\DataTransfertObjects
 */
class BaseDTO implements DTOInterface
{
     ...
     *
     * @param  \Core\Utils\DataTransfertObjects\DTOInterface $otherDTO The other DTO to compare with.
     ...
     * Check if the current DTO is equal to another DTO.
     *
     * @param  \Core\Utils\DataTransfertObjects\DTOInterface $other The other DTO to compare with.
