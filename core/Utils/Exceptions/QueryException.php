 ...
 */
class QueryException extends \Core\Utils\Exceptions\Contract\CoreException
{
    ...
    public function __construct(
        string $message = 'An error occurred while executing the query.',
        int $error_code =  ErrorCodeEnum::QUERY_EXCEPTION,
