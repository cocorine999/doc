...
namespace Core\Data\Eloquent\Casts;
 ...
 * ```
 *
 * @package \Core\Data\Eloquent\Casts
 */
class PhoneNumberCast implements CastsAttributes
{
     ...
     * @throws \Core\Utils\Exceptions\InvalidArgumentException If the value is not of type `PhoneNumber`, array, or null.
     */
