...
namespace Core\Logic\Services\RestJson\Contracts;
...
interface RestJsonReadWriteServiceContract extends RestJsonQueryServiceContract
{
     ...
     * @return void
     */
    public function setReadWriteService(\Core\Logic\Services\Contracts\ReadWriteServiceContract $service): void;
     ...
     */
    public function getReadWriteService(): \Core\Logic\Services\Contracts\ReadWriteServiceContract;
     ...
     */
    public function create(\Core\Utils\DataTransfertObjects\DTOInterface $data): \Illuminate\Http\JsonResponse;
     ...
     */
    public function update($id, \Core\Utils\DataTransfertObjects\DTOInterface $data): \Illuminate\Http\JsonResponse;
